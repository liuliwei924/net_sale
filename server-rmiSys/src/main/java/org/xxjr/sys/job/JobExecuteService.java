...
@Lazy
@Service
public class JobExecuteService extends BaseService {
	private static final String NAMESPACE = "JOBEXECUTE";
	...
	public AppResult delete(AppParam context) {
		...
		if (!StringUtils.isEmpty(ids)) {
			for (String id : ids.split(",")) {
				...
				param.addAttr("executeId", id);
				
				result = super.delete(param, NAMESPACE);
			}
		} else if (!StringUtils.isEmpty(context.getAttr("executeId"))) {
