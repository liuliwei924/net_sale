...
@Lazy
@Service
public class ActivityJoinService extends BaseService {
	private static final String NAMESPACE = "ACTIVITYJOIN";
	...
	public AppResult delete(AppParam context) {
		...
		if (!StringUtils.isEmpty(ids)) {
			for (String id : ids.split(",")) {
				...
				param.addAttr("joinId", id);
				
				result = super.delete(param, NAMESPACE);
			}
		} else if (!StringUtils.isEmpty(context.getAttr("joinId"))) {
