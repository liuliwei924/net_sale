...
@Configuration
@ConfigurationProperties(prefix = "sys.jdbc")
@ConditionalOnProperty(name = "sys.jdbc.url")//没配置不启用
public class SysJdbcConfig {
	static final String MAPPER_LOCATION = "classpath*:mybatis/sys/**/*.xml";
	...
	@Bean("sys_transactionManager")
	public DataSourceTransactionManager masterTransactionManager() {
		return new DataSourceTransactionManager(masterDataSource());
	}

	@Bean("sys_sqlSessionFactory")
	public SqlSessionFactoryBean masterSqlSessionFactory(
			@Qualifier("sys_dataSource") DataSource dataSource)
			throws Exception {
	...
	@Bean("sys_sqlSessionTemplate")
	public SqlSessionTemplate mainSqlSessionTemplate(@Qualifier("sys_sqlSessionFactory")SqlSessionFactory sqlSessionFactory) {
