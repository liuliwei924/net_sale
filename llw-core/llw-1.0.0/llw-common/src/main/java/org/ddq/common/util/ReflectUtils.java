...
public class ReflectUtils {
	...
	public static Method getPropertyReadMethod(Class beanClass, String propName) {
		...
		try {
			...
			LogerUtil.debug("getPropertyReadMethod NoSuchMethodException:" + propName);
			method = null;
		}
		return method;
	}
	...
	public static Object invokeMethod(Object bean, String methodName,Object params[]) {
		...
		try {
			...
			LogerUtil.debug(" invokeMethod NoSuchMethodException!" + methodName);
		} catch(Exception e){
			LogerUtil.debug(e, " invokeMethod error!");
		}
		return null;
	}
	...
	public static Method getPropertyWriteMethod(Class beanClass, String propName) {
		try {
			...
			LogerUtil.debug(" invokeMethod getPropertyWriteMethod!" + propName);
			return null;
		}
	}
