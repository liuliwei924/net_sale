...
@Configuration
@ConfigurationProperties(prefix = "cust.jdbc")
@ConditionalOnProperty(name = "cust.jdbc.url")//没配置不启用
public class CustJdbcConfig {
	static final String MAPPER_LOCATION = "classpath*:mybatis/cust/**/*.xml";
	...
	@Bean("cust_transactionManager")
	public DataSourceTransactionManager masterTransactionManager() {
		return new DataSourceTransactionManager(masterDataSource());
	}

	@Bean("cust_sqlSessionFactory")
	public SqlSessionFactoryBean masterSqlSessionFactory(
			@Qualifier("cust_dataSource") DataSource dataSource)
			throws Exception {
	...
	@Bean("cust_sqlSessionTemplate")
	public SqlSessionTemplate mainSqlSessionTemplate(@Qualifier("cust_sqlSessionFactory")SqlSessionFactory sqlSessionFactory) {
