...
@Lazy
@Service
public class SumRetChannelService extends BaseService {
	private static final String NAMESPACE = "SUMRETCHANNEL";
	 ...
	 * @return
	 */
	public AppResult updateSucRetAmount(AppParam params) {
		int size = getDao().update(NAMESPACE, "updateSucRetAmount", params.getAttr(), params.getDataBase());
