...
@Lazy
@Service
public class SumTotalBaseService extends BaseService {
	private static final String NAMESPACE = "SUMTOTALBASE";
	...
	public AppResult querySection(AppParam params) {
		return super.query(params, NAMESPACE,"querySection");
	}
	/**
	 * 总的本月统计总计
	 * @param params
	 * @return
	 */
	public AppResult queryDaySumTotal(AppParam params) {
		return super.query(params, NAMESPACE,"queryDaySumTotal");
	}
