...
@Lazy
@Service
public class ExportRecordService extends BaseService {
	private static final String NAMESPACE = "EXPORTRECORD";
	 ...
	 * @return
	 */
	public AppResult updateExpireStatus(AppParam params) {
		int size = this.getDao().update(NAMESPACE, "updateExpireStatus", params.getAttr(), params.getDataBase());
		AppResult result = new AppResult();
