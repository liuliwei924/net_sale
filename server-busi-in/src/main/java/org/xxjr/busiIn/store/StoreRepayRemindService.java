...
@Lazy
@Service
public class StoreRepayRemindService extends BaseService {
	private static final String NAMESPACE = "STOREREPAYREMIND";
	...
	/**
	 * queryRepayRemindList
	 * @param params
	 * @return
	 */
	public AppResult queryRepayRemindList(AppParam params) {
		return super.queryByPage(params, NAMESPACE,"queryRepayRemindList","queryRepayRemindCount");
	}
