...
@Lazy
@Service
public class AbilityValueCfgService extends BaseService {
	private static final String NAMESPACE = "ABILITYVALUECFG";
	...
	public AppResult delete(AppParam params) {
		...
		if (!StringUtils.isEmpty(ids)) {
			for (String id : ids.split(",")) {
				...
				param.addAttr("configId", id);
				
				result = super.delete(param, NAMESPACE);
			}
		} else if (!StringUtils.isEmpty(params.getAttr("configId"))) {
