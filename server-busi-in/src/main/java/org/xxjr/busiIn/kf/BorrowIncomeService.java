...
@Lazy
@Service
public class BorrowIncomeService extends BaseService {
	private static final String NAMESPACE = "BORROWINCOME";
...
//		int cashMonth = NumberUtil.getInt(params.getAttr("cashMonth"), 0);
//		if(cashMonth >=1000){//防止客户申请不看单位，以为是元单位
//			params.addAttr("cashMonth", cashMonth/10000);
//		}
